...
import 'package:pokedx/data/model/pokemon_model.dart' as pokemon;
import 'package:pokedx/ui/main/main_controller.dart';
              ...
              body: CustomScrollView(
                slivers: [
                  ...
                  PagedSliverGrid<int, pokemon.Results?>(
                    ...
                    builderDelegate:
                    PagedChildBuilderDelegate<pokemon.Results?>(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 8),
                                        child: Text("#${controller.formatter.format(int.parse(item?.url
                                            ?.split("pokemon")
                                            .last
                                            .replaceAll("/", "") ?? "0"))}"),
                                      ),
